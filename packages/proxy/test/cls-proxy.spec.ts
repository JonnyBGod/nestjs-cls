...
import { ClsModule, ClsModuleOptions, ClsService } from 'nestjs-cls';
import { ClsProxyModule } from '../src/lib/cls-proxy.module';
import { InjectableProxy } from '../src/lib/injectable-proxy.decorator';
...
async function getTestApp(forRootOptions: ClsModuleOptions) {
    @Module({
        imports: [
            ...
            ClsModule.registerPlugin(ClsProxyModule, { name: 'aaa' }),
            ClsProxyModule.forFeatureAsync({
